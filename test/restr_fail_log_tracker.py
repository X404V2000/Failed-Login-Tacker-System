...
def show_menu():
	...
	RESET = '\033[0m'
	print("="*100)
	print(" "*4,f"{GREEN}0110{RESET}"," "*5,f"{GREEN}0110 0110{RESET}", " "*7,f"{GREEN}0110 0110{RESET}", " "*13,f"{GREEN}0110 0110{RESET}", " "*8,f"{GREEN}0110 0110{RESET}", " "*4,f"{GREEN}0110 0110{RESET}")
	print(" "*3,f"{GREEN}0110{RESET}", " "*4,f"{GREEN}0110{RESET}", " "*3,f"{GREEN}0110{RESET}", " "*3,f"{GREEN}0110{RESET}", " "*3,f"{GREEN}0110{RESET}", " "*9,f"{GREEN}0110{RESET}", " "*2,f"{GREEN}0110{RESET}", " "*6,f"{GREEN}0110{RESET}", " "*8,f"{GREEN}0110{RESET}", " "*3,f"{GREEN}0110{RESET}")
	print(" "*2,f"{GREEN}0110{RESET}", " "*4,f"{GREEN}0110{RESET}", " "*5,f"{GREEN}0110{RESET}", " "*1,f"{GREEN}0110{RESET}", " "*21,f"{GREEN}0110{RESET}", " "*11,f"{GREEN}0110 0110{RESET}", " "*3,f"{GREEN}0110{RESET}")
	print(" "*1,f"{GREEN}0110{RESET}", " "*4,f"{GREEN}0110{RESET}", " "*5,f"{GREEN}0110{RESET}", " "*1,f"{GREEN}0110  0110 0110{RESET}", " "*14,f"{GREEN}0110{RESET}", " "*7,f"{GREEN}0110 0110{RESET}", " "*3,f"{GREEN}0110{RESET}")
	print("",f"{GREEN}0110 0110{RESET}", " "*1,f"{GREEN}0110{RESET}", " "*3,f"{GREEN}0110{RESET}", " "*3,f"{GREEN}0110{RESET}", " "*3,f"{GREEN}0110{RESET}", " ",f"{GREEN}0110{RESET}", " ",f"{GREEN}0110{RESET}", " "*2,f"{GREEN}0110{RESET}", " "*4,f"{GREEN}0110{RESET}", " "*11,f"{GREEN}0110{RESET}", " "*3,f"{GREEN}0110{RESET}")
	print(f"{GREEN}0110 0110{RESET}", " "*4,f"{GREEN}0110 0110{RESET}", " "*7,f"{GREEN}0110 0110{RESET}", " "*1,f"{GREEN}0110{RESET}", " "*5,f"{GREEN}0110 0110{RESET}", " "*4,f"{GREEN}0110 0110{RESET}", " "*9,f"{GREEN}0110 0110{RESET}")
